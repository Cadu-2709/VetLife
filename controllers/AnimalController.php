...
use app\models\AnimalSearch; // Você precisará criar este arquivo com o Gii para a busca funcionar
...
class AnimalController extends Controller
{
    ...
    {
        // O Gii cria o AnimalSearch para habilitar filtros e ordenação na listagem.
